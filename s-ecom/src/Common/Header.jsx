              ...
              <Link to="/" className="flex items-center space-x-3 group">
                <div className="relative">
                  ...
                  <img
                    ...
                    className="h-10 md:h-12 rounded-full object-contain transition-transform duration-300 group-hover:scale-105"
                  />
                </div>
              </Link>
            </div>
              ...
              <div className="relative" ref={profileRef}>
                ...
                >
                  {isAuthenticated && firstChar ? (
                    <div className="w-7 h-7 md:w-8 md:h-8 bg-[#CBE600] text-[#111111] font-bold rounded-full flex items-center justify-center text-sm shadow-md select-none">
                      {firstChar}
                    </div>
                  ) : (
                    <>
