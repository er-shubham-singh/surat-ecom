      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12">
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="xl:col-span-2 space-y-4">
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-6">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between mb-2">
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap items-center gap-2 md:gap-4 text-xs md:text-sm text-gray-600 mb-2">
                          <span>
                            Color:{" "}
                            <span className="font-medium text-[#222426]">
                              {item.color}
                            </span>
                          </span>
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mt-4">
                      ...
                      <div className="flex items-center border-2 border-gray-300 rounded-lg overflow-hidden mx-auto md:mx-0">
                        <button
                          ...
                          className="w-8 md:w-10 h-8 md:h-10 flex items-center justify-center hover:bg-gray-100 transition-colors"
                        >
                      ...
                      <div className="text-left sm:text-right">
                        <div className="flex items-center gap-2 md:gap-3">
                          <span className="text-lg md:text-xl font-bold text-[#8A6F4F]">
                    ...
                    <div className="flex flex-wrap gap-3 md:gap-4 mt-4 pt-4 border-t border-gray-200">
                      ...
                      <button className="flex items-center gap-2 text-xs md:text-sm text-gray-600 hover:text-red-500 transition-colors font-medium">
            ...
            <a
              href="/products"
              className="inline-flex items-center gap-2 text-sm md:text-base text-[#8A6F4F] font-semibold hover:gap-3 transition-all duration-300"
            >
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-lg p-4 md:p-6 sticky top-20 md:top-24">
              <h2 className="text-xl md:text-2xl font-serif font-semibold text-[#222426] mb-4 md:mb-6">
                Order Summary
              </h2>
              ...
              <div className="mb-4 md:mb-6 pb-4 md:pb-6 border-b border-gray-200">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={applyCoupon}
                    className="px-4 md:px-6 py-2 md:py-3 text-sm md:text-base bg-[#8A6F4F] text-white font-semibold rounded-lg hover:bg-[#CBE600] hover:text-black transition-all duration-300"
                  >
                    Apply
                  </button>
                </div>
                ...
                <div className="mt-3 space-y-1">
                  <p className="text-xs text-gray-500">
                    Try:{" "}
                    <span className="font-semibold text-[#8A6F4F]">SAVE10</span>{" "}
                    or{" "}
              ...
              {/* Checkout Button */}
              <button className="w-full py-3 md:py-4 px-4 md:px-6 bg-[#CBE600] text-white font-bold text-base md:text-lg rounded-xl hover:bg-[#DFF200] hover:text-black transition-all duration-300 shadow-lg hover:shadow-2xl hover:-translate-y-1 uppercase tracking-wide mb-4">
                Proceed to Checkout
              </button>
        ...
        <div className="mt-12 md:mt-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 gap-4 md:gap-6">
            {recommendedProducts.map((product) => (
              <article
                key={product.id}
                className="group bg-white rounded-xl overflow-hidden shadow-lg border-2 border-transparent hover:border-[#DFF200] transition-all duration-500 hover:shadow-2xl hover:-translate-y-2"
              >
                ...
                <div className="p-4 md:p-5">
                  <h3 className="text-sm md:text-base font-semibold text-[#222426] mb-3 group-hover:text-[#CBE600] transition-colors duration-300 line-clamp-2">
                    {product.name}
                  </h3>
                  <div className="flex items-center justify-between">
                    ...
                    <button className="px-3 md:px-4 py-2 bg-black text-white text-xs md:text-sm font-semibold rounded-lg hover:bg-[#CBE600] hover:text-black transition-all duration-300 uppercase">
                      Add
                    </button>
                  </div>
                </div>
